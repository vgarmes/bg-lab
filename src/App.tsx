          ...
          <aside className="absolute left-0 top-0 bottom-0 w-70 bg-background/95 backdrop-blur-sm border-r transition-transform duration-300 ease-in-out z-10 translate-x-0 data-[open=false]:-translate-x-full">
            <div className="flex-1 min-h-0 p-4 overflow-hidden">
              <div className="space-y-4">
                ...
                <Collapsible
                  open={maskEnabled}
                  onOpenChange={setMaskEnabled}
                  className="space-y-4"
                >
                  <div className="flex items-center justify-between gap-2">
                    <h4 className="text-muted-foreground font-normal text-sm flex-nowrap shrink-0 min-w-20">
                      Fade
                    </h4>
                    <CollapsibleTrigger
                      render={
                        <Switch
                          id="mask-enable"
                          checked={maskEnabled}
                          onCheckedChange={setMaskEnabled}
                        />
                      }
                    />
                  </div>
