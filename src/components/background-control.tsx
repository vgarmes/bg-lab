...
export function BackgroundControl({ background, onChange }: Props) {
  ...
  return (
    <Tabs
      ...
      onValueChange={(value) => onChange({ type: value as BackgroundConfig["type"] })}
    >
      ...
      <TabsContent value="gradient" className="space-y-4">
        ...
        <div className="space-y-2 pt-2">
          ...
          <ToggleGroup
            ...
            value={[gradient.type]}
            onValueChange={(value) =>
              patchGradient({ type: value[0] as BackgroundGradientConfig["type"] })
            }
          >
              ...
              {gradient.type === "circle" && (
                <>
                  ...
                  <SliderControl
                    ...
                    onValueChange={(v) =>
                      patchGradient({ circle: { ...gradient.circle, fromStop: v } })
                    }
                    min={0}
                    max={150}
                    step={1}
              ...
              {gradient.type === "ellipse" && (
                <>
                  ...
                  <SliderControl
                    ...
                    onValueChange={(v) =>
                      patchGradient({ ellipse: { ...gradient.ellipse, fromStop: v } })
                    }
                    min={0}
                    max={150}
                    step={1}
                  ...
                  <SliderControl
                    ...
                    onValueChange={(v) =>
                      patchGradient({ ellipse: { ...gradient.ellipse, toStop: v } })
                    }
                    min={0}
                    max={150}
                    step={1}
